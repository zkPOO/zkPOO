              ...
              if (chain.unsupported || chain.id !== configuredNetwork.id) {
                return (
                  <div className="dropdown dropdown-end">
                    <label tabIndex={0} className="btn btn-error btn-sm dropdown-toggle gap-1 h-10 w-36 ">
                      <span>Wrong network</span>
                      {/* <ChevronDownIcon className="h-6 w-4 ml-2 sm:ml-0" /> */}
                    </label>
                    <ul
                      tabIndex={0}
                      className="dropdown-content menu z-[2] p-2 mt-2 shadow-center bg-base-200 gap-1 border border-secondary-content rounded-lg"
                    >
                      <li>
                        <button
